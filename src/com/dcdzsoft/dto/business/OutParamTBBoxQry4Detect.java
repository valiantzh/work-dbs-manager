...
public class OutParamTBBoxQry4Detect implements java.io.Serializable
{
	...
	public double BoxHeight; //箱高度
	public double BoxWidth; //箱宽度
	public int ArticeStatus; //物品状态
	public int OpenStatus; //箱门状态
	...
	public int getArticeStatus()
	{
		return ArticeStatus;
	}
	public void setArticeStatus(int ArticeStatus)
	{
		this.ArticeStatus = ArticeStatus;
	}
