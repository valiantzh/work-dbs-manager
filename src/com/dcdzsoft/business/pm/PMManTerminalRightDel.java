...
public class PMManTerminalRightDel extends ActionBean {

	public int doBusiness(InParamPMManTerminalRightDel in) throws EduException {
		...
		for (String TerminalNo : lockerList) {
			...
			manTerminalRightDAO.delete(manTerminalRight);
		}
