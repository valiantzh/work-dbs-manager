...
public class PMPostmanModComp extends ActionBean
{

    public int doBusiness(InParamPMPostmanModComp in) throws EduException
    {
		...
		log.Remark = "old=" + postman.CompanyID + ",new=" + in.CompanyID;
