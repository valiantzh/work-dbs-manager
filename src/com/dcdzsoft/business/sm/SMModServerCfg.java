...
public class SMModServerCfg extends ActionBean {

    public int doBusiness(InParamSMModServerCfg in) throws EduException {
        ...
        if (StringUtils.isEmpty(in.OperID)
            ...
            || StringUtils.isEmpty(in.ServerIP)
            || in.ServerPort <= 0
            || StringUtils.isEmpty(in.ServerSSL))
        ...
        setCols.add("ServerIP",in.ServerIP);
        setCols.add("ServerPort",in.ServerPort);
        //setCols.add("ServerSSL",in.ServerSSL);
