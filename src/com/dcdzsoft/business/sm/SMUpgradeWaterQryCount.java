...
public class SMUpgradeWaterQryCount extends ActionBean
{

    public int doBusiness(InParamSMUpgradeWaterQryCount in) throws EduException
    {
		...
		if(in.BeginDate == null){
            in.BeginDate = DateUtils.addDate(sysDate, -30);
        }
		...
		String sql = "SELECT COUNT(UpgradeWaterID) FROM V_SMUpgradeWater a WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitSQL;
