...
public class SMUpgradePackQry extends ActionBean
{

    public RowSet doBusiness(InParamSMUpgradePackQry in) throws EduException
    {
		...
		String sql = "SELECT * FROM V_SMUpgradePack a WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitSQL;
		java.util.LinkedList list = new java.util.LinkedList();
        list.add("SoftwareID DESC");
