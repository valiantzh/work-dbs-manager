...
public class SMSystemInfoQry extends ActionBean
{

    public RowSet doBusiness(InParamSMSystemInfoQry in) throws EduException
    {
		...
		String sql = "SELECT * FROM V_SMSystemInfo0 a WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitSQL;
		java.util.LinkedList list = new java.util.LinkedList();
        list.add("SystemID DESC");
