...
public class TBTerminalModDepartID extends ActionBean {

    public int doBusiness(InParamTBTerminalModDepartID in) throws EduException {
        ...
        setCols1.add("DepartmentID", in.DepartmentID);
