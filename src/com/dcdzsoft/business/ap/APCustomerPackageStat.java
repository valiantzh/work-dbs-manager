...
public class APCustomerPackageStat extends ActionBean
{

    public java.util.List<OutParamAPCustomerPackageStat> doBusiness(InParamAPCustomerPackageStat in) throws EduException
    {
		...
		java.util.List<OutParamAPCustomerPackageStat> outList = new java.util.LinkedList<OutParamAPCustomerPackageStat>();
		...
		while (RowSetUtils.rowsetNext(rset)) {
			OutParamAPCustomerPackageStat outParam = new OutParamAPCustomerPackageStat();
