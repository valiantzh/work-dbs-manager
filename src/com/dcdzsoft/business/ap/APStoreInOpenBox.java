...
public class APStoreInOpenBox extends ActionBean
{

    public OutParamAPStoreInOpenBox doBusiness(InParamAPStoreInOpenBox in) throws EduException
    {
        utilDAO = this.getUtilDAO();
        commonDAO = this.getCommonDAO();
        dbSession = this.getCurrentDBSession();
        OutParamAPStoreInOpenBox out = new OutParamAPStoreInOpenBox();
