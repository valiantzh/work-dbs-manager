...
public class APManagerAppOpenBox extends ActionBean
{

    public String doBusiness(InParamAPManagerAppOpenBox in) throws EduException
    {
		...
		log.StationAddr = "";
		log.Remark = in.TerminalNo + "," + in.PackageID + "," + in.CustomerMobile;
