...
public class MBOpenBoxWaterQry extends ActionBean
{

    public RowSet doBusiness(InParamMBOpenBoxWaterQry in) throws EduException
    {
        ...
        String sql = "SELECT * FROM V_MBOpenBoxWater a WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitSQL;
