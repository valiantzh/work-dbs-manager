...
public class QYStat4Terminal extends ActionBean
{

    public RowSet doBusiness(InParamQYStat4Terminal in) throws EduException
    {
        ...
        String sql = "SELECT '" + reportID + "' AS ReportID,TerminalNo,TerminalName,SUM(InBoxNum) AS InBoxNum,SUM(TakeOutNum) AS TakeOutNum,SUM(TakeBackNum) AS TakeBackNum,SUM(ExpiredNum) AS ExpiredNum,SUM(ManagerOutNum) AS ManagerOutNum FROM V_OrderStat1 a WHERE 1=1 ";
