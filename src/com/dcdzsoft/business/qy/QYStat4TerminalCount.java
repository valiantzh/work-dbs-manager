...
public class QYStat4TerminalCount extends ActionBean
{

    public int doBusiness(InParamQYStat4TerminalCount in) throws EduException
    {
        ...
        String sql = "SELECT TerminalNo,TerminalName FROM V_OrderStat1 a WHERE 1=1 ";
