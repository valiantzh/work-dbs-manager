...
public class QYOrderInboxTimeStatCount extends ActionBean
{

    public int doBusiness(InParamQYOrderInboxTimeStatCount in) throws EduException
    {
        ...
        String sql = "SELECT COUNT(PackageID) FROM V_OrderStatInBoxTime a WHERE 1=1 " 
