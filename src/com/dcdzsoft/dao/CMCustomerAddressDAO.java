...
public interface CMCustomerAddressDAO
{
	public int insert(CMCustomerAddress obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(CMCustomerAddress obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(CMCustomerAddress obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public CMCustomerAddress find(CMCustomerAddress obj) throws EduException;
