...
public interface MBTerminalAlertLogDAO
{
	public int insert(MBTerminalAlertLog obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(MBTerminalAlertLog obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(MBTerminalAlertLog obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public MBTerminalAlertLog find(MBTerminalAlertLog obj) throws EduException;
