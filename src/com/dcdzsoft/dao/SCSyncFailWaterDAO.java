...
public interface SCSyncFailWaterDAO
{
	public int insert(SCSyncFailWater obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(SCSyncFailWater obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(SCSyncFailWater obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public SCSyncFailWater find(SCSyncFailWater obj) throws EduException;
