...
public interface PYTransactionWaterDAO
{
	public int insert(PYTransactionWater obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(PYTransactionWater obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(PYTransactionWater obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public PYTransactionWater find(PYTransactionWater obj) throws EduException;
