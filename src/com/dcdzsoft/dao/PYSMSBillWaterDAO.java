...
public interface PYSMSBillWaterDAO
{
	public int insert(PYSMSBillWater obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(PYSMSBillWater obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(PYSMSBillWater obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public PYSMSBillWater find(PYSMSBillWater obj) throws EduException;
