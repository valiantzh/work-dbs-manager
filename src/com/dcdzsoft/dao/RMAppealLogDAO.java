...
public interface RMAppealLogDAO
{
	public int insert(RMAppealLog obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(RMAppealLog obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(RMAppealLog obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public RMAppealLog find(RMAppealLog obj) throws EduException;
