...
public interface SMTerminalSoftDAO
{
	public int insert(SMTerminalSoft obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(SMTerminalSoft obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(SMTerminalSoft obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public SMTerminalSoft find(SMTerminalSoft obj) throws EduException;
