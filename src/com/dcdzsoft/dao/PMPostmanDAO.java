...
public interface PMPostmanDAO
{
	public int insert(PMPostman obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(PMPostman obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(PMPostman obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public PMPostman find(PMPostman obj) throws EduException;
