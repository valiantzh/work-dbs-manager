...
public interface MBOpenBoxWaterDAO
{
	public int insert(MBOpenBoxWater obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(MBOpenBoxWater obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(MBOpenBoxWater obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public MBOpenBoxWater find(MBOpenBoxWater obj) throws EduException;
