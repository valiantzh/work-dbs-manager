...
public interface MBDeliveryReportDAO
{
	public int insert(MBDeliveryReport obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(MBDeliveryReport obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(MBDeliveryReport obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public MBDeliveryReport find(MBDeliveryReport obj) throws EduException;
