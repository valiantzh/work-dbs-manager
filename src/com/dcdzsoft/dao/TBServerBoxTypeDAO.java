...
public interface TBServerBoxTypeDAO
{
	public int insert(TBServerBoxType obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(TBServerBoxType obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(TBServerBoxType obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public TBServerBoxType find(TBServerBoxType obj) throws EduException;
