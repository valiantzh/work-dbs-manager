...
public interface MBPwdShortMsgDAO
{
	public int insert(MBPwdShortMsg obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(MBPwdShortMsg obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(MBPwdShortMsg obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public MBPwdShortMsg find(MBPwdShortMsg obj) throws EduException;
