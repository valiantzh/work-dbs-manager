...
public interface TBLedParamDAO
{
	public int insert(TBLedParam obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(TBLedParam obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(TBLedParam obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public TBLedParam find(TBLedParam obj) throws EduException;
