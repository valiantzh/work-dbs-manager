...
public interface MBSignInfoDAO
{
	public int insert(MBSignInfo obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(MBSignInfo obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(MBSignInfo obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public MBSignInfo find(MBSignInfo obj) throws EduException;
