...
public interface MBReminderWaterDAO
{
	public int insert(MBReminderWater obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(MBReminderWater obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(MBReminderWater obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public MBReminderWater find(MBReminderWater obj) throws EduException;
