...
public interface SMSystemInfoDAO
{
	public int insert(SMSystemInfo obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(SMSystemInfo obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(SMSystemInfo obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public SMSystemInfo find(SMSystemInfo obj) throws EduException;
