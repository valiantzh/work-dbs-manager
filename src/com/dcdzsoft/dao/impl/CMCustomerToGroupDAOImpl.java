...
public class CMCustomerToGroupDAOImpl implements CMCustomerToGroupDAO
{
	private static final Log log = LogFactory.getLog(CMCustomerToGroupDAOImpl.class.getName());
	...
	public int insert(CMCustomerToGroup obj) throws EduException
	{
		...
		String sql = "INSERT INTO CMCustomerToGroup(CustomerID,GroupId,Remark)VALUES(?,?,?)";
		...
		try
		{
			...
			PreparedStmtUtils.setString(pstmt,2,obj.GroupId);
		...
		{
			String errorCode = ErrorCode.ERR_ADDCMCUSTOMERTOGROUPFAIL;
	...
	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "UPDATE CMCustomerToGroup SET ";
		...
		SQLLog.logUpdate(log,"CMCustomerToGroup",setCols,whereCols);
		...
		{
			String errorCode = ErrorCode.ERR_MODCMCUSTOMERTOGROUPFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(CMCustomerToGroup obj) throws EduException
	{
		...
		String sql = "DELETE FROM CMCustomerToGroup WHERE CustomerID = ?  AND GroupId = ? ";

		log.debug("[delete sql]:" + "DELETE FROM CMCustomerToGroup WHERE CustomerID = " + StringUtils.addQuote(obj.CustomerID) +
						" AND GroupId = " + StringUtils.addQuote(obj.GroupId) );
		...
		{
			String errorCode = ErrorCode.ERR_DELCMCUSTOMERTOGROUPFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "DELETE FROM CMCustomerToGroup WHERE 1=1 " ;
		...
		SQLLog.logDelete(log,"CMCustomerToGroup",whereCols);
	...
	public boolean isExist(CMCustomerToGroup obj) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM CMCustomerToGroup WHERE CustomerID = ?  AND GroupId = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM CMCustomerToGroup WHERE CustomerID = " + StringUtils.addQuote(obj.CustomerID) +
						" AND GroupId = " + StringUtils.addQuote(obj.GroupId) );
		...
		{
			String errorCode = ErrorCode.ERR_QRYCMCUSTOMERTOGROUPFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int isExist(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM CMCustomerToGroup WHERE 1=1 " ;
		...
		SQLLog.logIsExist(log,"CMCustomerToGroup",whereCols);
	...
	{
		CMCustomerToGroup result = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = "SELECT CustomerID,GroupId,Remark  FROM CMCustomerToGroup WHERE CustomerID = ?  AND GroupId = ? ";

		log.debug("[find sql]:" + "SELECT CustomerID,GroupId,Remark  FROM CMCustomerToGroup WHERE CustomerID = " + StringUtils.addQuote(obj.CustomerID) +
						" AND GroupId = " + StringUtils.addQuote(obj.GroupId) );
		...
		try
		{
			...
			if(rset.next() == true)
			{
				result = new CMCustomerToGroup();
				result.CustomerID = rset.getString(1);
				result.GroupId = rset.getString(2);
				result.Remark = rset.getString(3);

			}
			else
			{
				throw new EduException(ErrorCode.ERR_CMCUSTOMERTOGROUPNODATA);
			}
		}
		catch(SQLException e)
		{
	...
	public RowSet select(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT * FROM CMCustomerToGroup WHERE 1=1 ";
	...
	public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT " + fName + " FROM CMCustomerToGroup WHERE 1=1 ";
