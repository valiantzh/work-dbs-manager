...
public class CMCustomerTerminalRightDAOImpl implements CMCustomerTerminalRightDAO
{
	private static final Log log = LogFactory.getLog(CMCustomerTerminalRightDAOImpl.class.getName());
	...
	public int insert(CMCustomerTerminalRight obj) throws EduException
	{
		...
		String sql = "INSERT INTO CMCustomerTerminalRight(TerminalNo,CustomerID,Remark)VALUES(?,?,?)";
		...
		{
			String errorCode = ErrorCode.ERR_ADDCMCUSTOMERTERMINALRIGHTFAIL;
	...
	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "UPDATE CMCustomerTerminalRight SET ";
		...
		SQLLog.logUpdate(log,"CMCustomerTerminalRight",setCols,whereCols);
		...
		{
			String errorCode = ErrorCode.ERR_MODCMCUSTOMERTERMINALRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(CMCustomerTerminalRight obj) throws EduException
	{
		...
		String sql = "DELETE FROM CMCustomerTerminalRight WHERE TerminalNo = ?  AND CustomerID = ? ";

		log.debug("[delete sql]:" + "DELETE FROM CMCustomerTerminalRight WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND CustomerID = " + StringUtils.addQuote(obj.CustomerID) );
		...
		{
			String errorCode = ErrorCode.ERR_DELCMCUSTOMERTERMINALRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "DELETE FROM CMCustomerTerminalRight WHERE 1=1 " ;
		...
		SQLLog.logDelete(log,"CMCustomerTerminalRight",whereCols);
	...
	public boolean isExist(CMCustomerTerminalRight obj) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM CMCustomerTerminalRight WHERE TerminalNo = ?  AND CustomerID = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM CMCustomerTerminalRight WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND CustomerID = " + StringUtils.addQuote(obj.CustomerID) );
		...
		{
			String errorCode = ErrorCode.ERR_QRYCMCUSTOMERTERMINALRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int isExist(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM CMCustomerTerminalRight WHERE 1=1 " ;
		...
		SQLLog.logIsExist(log,"CMCustomerTerminalRight",whereCols);
	...
	{
		CMCustomerTerminalRight result = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = "SELECT TerminalNo,CustomerID,Remark  FROM CMCustomerTerminalRight WHERE TerminalNo = ?  AND CustomerID = ? ";

		log.debug("[find sql]:" + "SELECT TerminalNo,CustomerID,Remark  FROM CMCustomerTerminalRight WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND CustomerID = " + StringUtils.addQuote(obj.CustomerID) );
		...
		try
		{
			...
			if(rset.next() == true)
			{
				result = new CMCustomerTerminalRight();
			...
			{
				throw new EduException(ErrorCode.ERR_CMCUSTOMERTERMINALRIGHTNODATA);
			}
		}
		catch(SQLException e)
		{
	...
	public RowSet select(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT * FROM CMCustomerTerminalRight WHERE 1=1 ";
	...
	public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT " + fName + " FROM CMCustomerTerminalRight WHERE 1=1 ";
