...
public class PTReadyPackageDAOImpl implements PTReadyPackageDAO
{
	...
	public int insert(PTReadyPackage obj) throws EduException
	{
		...
		String sql = "INSERT INTO PTReadyPackage(TerminalNo,PackageID,OrderTime,ExpiredTime,PostmanID,CompanyID,BoxNo,CustomerID,CustomerMobile,CustomerName,CustomerAddress,HireAmt,HireWhoPay,PosPayFlag,PayAmt,PackageStatus,LastModifyTime,Remark)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		...
		try
		{
			...
			PreparedStmtUtils.setTimestamp(pstmt,3,obj.OrderTime);
			PreparedStmtUtils.setTimestamp(pstmt,4,obj.ExpiredTime);
			PreparedStmtUtils.setString(pstmt,5,obj.PostmanID);
			PreparedStmtUtils.setString(pstmt,6,obj.CompanyID);
			PreparedStmtUtils.setString(pstmt,7,obj.BoxNo);
			PreparedStmtUtils.setString(pstmt,8,obj.CustomerID);
			PreparedStmtUtils.setString(pstmt,9,obj.CustomerMobile);
			PreparedStmtUtils.setString(pstmt,10,obj.CustomerName);
			PreparedStmtUtils.setString(pstmt,11,obj.CustomerAddress);
			PreparedStmtUtils.setDouble(pstmt,12,obj.HireAmt);
			PreparedStmtUtils.setString(pstmt,13,obj.HireWhoPay);
			PreparedStmtUtils.setString(pstmt,14,obj.PosPayFlag);
			PreparedStmtUtils.setDouble(pstmt,15,obj.PayAmt);
			PreparedStmtUtils.setString(pstmt,16,obj.PackageStatus);
	...
	public int delete(PTReadyPackage obj) throws EduException
	{
		...
		String sql = "DELETE FROM PTReadyPackage WHERE TerminalNo = ?  AND PackageID = ? ";

		log.debug("[delete sql]:" + "DELETE FROM PTReadyPackage WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
	...
	public boolean isExist(PTReadyPackage obj) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM PTReadyPackage WHERE TerminalNo = ?  AND PackageID = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM PTReadyPackage WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND PackageID = " + StringUtils.addQuote(obj.PackageID) );
	...
	public PTReadyPackage find(PTReadyPackage obj) throws EduException
	{
		...
		String sql = "SELECT TerminalNo,PackageID,OrderTime,ExpiredTime,PostmanID,CompanyID,BoxNo,CustomerID,CustomerMobile,CustomerName,CustomerAddress,HireAmt,HireWhoPay,PosPayFlag,PayAmt,PackageStatus,LastModifyTime,Remark  FROM PTReadyPackage WHERE TerminalNo = ?  AND PackageID = ? ";

		log.debug("[find sql]:" + "SELECT TerminalNo,PackageID,OrderTime,ExpiredTime,PostmanID,CompanyID,BoxNo,CustomerID,CustomerMobile,CustomerName,CustomerAddress,HireAmt,HireWhoPay,PosPayFlag,PayAmt,PackageStatus,LastModifyTime,Remark  FROM PTReadyPackage WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND PackageID = " + StringUtils.addQuote(obj.PackageID) );
		...
		try
		{
			...
			if(rset.next() == true)
			{
				...
				result.OrderTime = rset.getTimestamp(3);
				result.ExpiredTime = rset.getTimestamp(4);
				result.PostmanID = rset.getString(5);
				result.CompanyID = rset.getString(6);
				result.BoxNo = rset.getString(7);
				result.CustomerID = rset.getString(8);
				result.CustomerMobile = rset.getString(9);
				result.CustomerName = rset.getString(10);
				result.CustomerAddress = rset.getString(11);
				result.HireAmt = rset.getDouble(12);
				result.HireWhoPay = rset.getString(13);
				result.PosPayFlag = rset.getString(14);
				result.PayAmt = rset.getDouble(15);
				result.PackageStatus = rset.getString(16);
