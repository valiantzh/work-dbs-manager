...
public class CMCustomerBoxRightDAOImpl implements CMCustomerBoxRightDAO
{
	private static final Log log = LogFactory.getLog(CMCustomerBoxRightDAOImpl.class.getName());
	...
	public int insert(CMCustomerBoxRight obj) throws EduException
	{
		...
		String sql = "INSERT INTO CMCustomerBoxRight(CustomerID,TerminalNo,BoxNo,Remark)VALUES(?,?,?,?)";
		...
		{
			String errorCode = ErrorCode.ERR_ADDCMCUSTOMERBOXRIGHTFAIL;
	...
	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "UPDATE CMCustomerBoxRight SET ";
		...
		SQLLog.logUpdate(log,"CMCustomerBoxRight",setCols,whereCols);
		...
		{
			String errorCode = ErrorCode.ERR_MODCMCUSTOMERBOXRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(CMCustomerBoxRight obj) throws EduException
	{
		...
		String sql = "DELETE FROM CMCustomerBoxRight WHERE TerminalNo = ?  AND CustomerID = ?  AND BoxNo = ? ";

		log.debug("[delete sql]:" + "DELETE FROM CMCustomerBoxRight WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
		...
		{
			String errorCode = ErrorCode.ERR_DELCMCUSTOMERBOXRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "DELETE FROM CMCustomerBoxRight WHERE 1=1 " ;
		...
		SQLLog.logDelete(log,"CMCustomerBoxRight",whereCols);
	...
	public boolean isExist(CMCustomerBoxRight obj) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM CMCustomerBoxRight WHERE TerminalNo = ?  AND CustomerID = ?  AND BoxNo = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM CMCustomerBoxRight WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND CustomerID = " + StringUtils.addQuote(obj.CustomerID) +
						" AND BoxNo = " + StringUtils.addQuote(obj.BoxNo) );
		...
		{
			String errorCode = ErrorCode.ERR_QRYCMCUSTOMERBOXRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int isExist(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM CMCustomerBoxRight WHERE 1=1 " ;
		...
		SQLLog.logIsExist(log,"CMCustomerBoxRight",whereCols);
	...
	{
		CMCustomerBoxRight result = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = "SELECT CustomerID,TerminalNo,BoxNo,Remark  FROM CMCustomerBoxRight WHERE TerminalNo = ?  AND CustomerID = ?  AND BoxNo = ? ";

		log.debug("[find sql]:" + "SELECT CustomerID,TerminalNo,BoxNo,Remark  FROM CMCustomerBoxRight WHERE TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) +
						" AND CustomerID = " + StringUtils.addQuote(obj.CustomerID) +
						" AND BoxNo = " + StringUtils.addQuote(obj.BoxNo) );
		...
		try
		{
			...
			{
				throw new EduException(ErrorCode.ERR_CMCUSTOMERBOXRIGHTNODATA);
			}
		}
		catch(SQLException e)
		{
	...
	public RowSet select(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT * FROM CMCustomerBoxRight WHERE 1=1 ";
	...
	public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT " + fName + " FROM CMCustomerBoxRight WHERE 1=1 ";
