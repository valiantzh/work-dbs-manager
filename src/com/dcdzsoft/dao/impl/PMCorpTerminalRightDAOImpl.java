...
public class PMCorpTerminalRightDAOImpl implements PMCorpTerminalRightDAO
{
	private static final Log log = LogFactory.getLog(PMCorpTerminalRightDAOImpl.class.getName());
	...
	public int insert(PMCorpTerminalRight obj) throws EduException
	{
		PreparedStatement pstmt = null;
		int result = 0;

		String sql = "INSERT INTO PMCorpTerminalRight(CompanyID,TerminalNo,Remark)VALUES(?,?,?)";
		...
		{
			String errorCode = ErrorCode.ERR_ADDPMCORPTERMINALRIGHTFAIL;
	...
	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "UPDATE PMCorpTerminalRight SET ";
		...
		SQLLog.logUpdate(log,"PMCorpTerminalRight",setCols,whereCols);
		...
		{
			String errorCode = ErrorCode.ERR_MODPMCORPTERMINALRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(PMCorpTerminalRight obj) throws EduException
	{
		PreparedStatement pstmt = null;
		int result = 0;

		String sql = "DELETE FROM PMCorpTerminalRight WHERE CompanyID = ?  AND TerminalNo = ? ";

		log.debug("[delete sql]:" + "DELETE FROM PMCorpTerminalRight WHERE CompanyID = " + StringUtils.addQuote(obj.CompanyID) +
		...
		{
			String errorCode = ErrorCode.ERR_DELPMCORPTERMINALRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "DELETE FROM PMCorpTerminalRight WHERE 1=1 " ;
		...
		SQLLog.logDelete(log,"PMCorpTerminalRight",whereCols);
	...
	public boolean isExist(PMCorpTerminalRight obj) throws EduException
	{
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		String sql = "SELECT COUNT(*) FROM PMCorpTerminalRight WHERE CompanyID = ?  AND TerminalNo = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM PMCorpTerminalRight WHERE CompanyID = " + StringUtils.addQuote(obj.CompanyID) +
						" AND TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) );
		...
		{
			String errorCode = ErrorCode.ERR_QRYPMCORPTERMINALRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int isExist(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM PMCorpTerminalRight WHERE 1=1 " ;
		...
		SQLLog.logIsExist(log,"PMCorpTerminalRight",whereCols);
	...
	public PMCorpTerminalRight find(PMCorpTerminalRight obj) throws EduException
	{
		PMCorpTerminalRight result = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = "SELECT CompanyID,TerminalNo,Remark  FROM PMCorpTerminalRight WHERE CompanyID = ?  AND TerminalNo = ? ";

		log.debug("[find sql]:" + "SELECT CompanyID,TerminalNo,Remark  FROM PMCorpTerminalRight WHERE CompanyID = " + StringUtils.addQuote(obj.CompanyID) +
						" AND TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) );
		...
		try
		{
			...
			if(rset.next() == true)
			{
				result = new PMCorpTerminalRight();
			...
			{
				throw new EduException(ErrorCode.ERR_PMCORPTERMINALRIGHTNODATA);
			}
		}
		catch(SQLException e)
		{
	...
	public RowSet select(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT * FROM PMCorpTerminalRight WHERE 1=1 ";
	...
	public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT " + fName + " FROM PMCorpTerminalRight WHERE 1=1 ";
