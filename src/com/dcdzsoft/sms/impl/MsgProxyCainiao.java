...
public class MsgProxyCainiao implements ISMSProxy {
	private static Log log = org.apache.commons.logging.LogFactory.getLog(MsgProxyCainiao.class);
	...
	public String sendMessage(SMSInfo smsInfo) throws EduException
	{
		if(smsInfo.MsgType == SMSInfo.MSG_TYPE_REGISTER)
			return _doSendRegisterSMS(smsInfo);
		else if(smsInfo.MsgType == SMSInfo.MSG_TYPE_RESENT)
			return _doResentSMS(smsInfo);
		
		//不需要发送短信
		return "0";
	}
	
	private String _doResentSMS(SMSInfo smsInfo)throws EduException{
		String result = "";
        ...
        NameValuePair[] data ={ //new NameValuePair("Uid", DEFAULT_UID),
        		                ...
        		                new NameValuePair("StaOrderID",smsInfo.StaOrderID),
	...
	private String _doSendRegisterSMS(SMSInfo smsInfo)throws EduException{
		String result = "";
