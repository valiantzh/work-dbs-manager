...
public class MsgProxyChangchunhaixu implements ISMSProxy {
	...
	public String sendMessage(SMSInfo smsInfo) throws EduException 
	{
		...
		if(SMSInfo.MSG_TYPE_DELIVERY == smsInfo.MsgType)
			tag = "1";
		else if(SMSInfo.MSG_TYPE_EXPIRED == smsInfo.MsgType)
			tag = "2";
		else if(SMSInfo.MSG_TYPE_REMINDER == smsInfo.MsgType)
			tag = "3";
		
        PostMethod post = new PostMethod("http://shequ.haixusoft.com/api/box_sms.php");
        post.addRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf8");//在头文件中设置转码
        NameValuePair[] data ={ new NameValuePair("phone", smsInfo.CustomerMobile),
        		                ...
        		                new NameValuePair("sdeviceid",smsInfo.TerminalNo),
