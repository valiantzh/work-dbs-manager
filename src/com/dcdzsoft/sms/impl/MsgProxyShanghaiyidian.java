...
public class MsgProxyShanghaiyidian implements ISMSProxy {
	private static Log log = org.apache.commons.logging.LogFactory.getLog(MsgProxyShanghaiyidian.class);
	...
	public String sendMessage(SMSInfo smsInfo) throws EduException
	{
        ...
        PostMethod post = new PostMethod("http://www.ztsms.cn:8800/sendSms.do");
        post.addRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf8");//在头文件中设置转码
        NameValuePair[] data ={ new NameValuePair("username", apCfg.getGatewayUser()),
        		                new NameValuePair("password", SecurityUtils.md5(apCfg.getGatewayPwd())),
        		                new NameValuePair("mobile",smsInfo.CustomerMobile),
        		                new NameValuePair("content",smsInfo.MsgContent),
        		                new NameValuePair("dstime",""),
        		                new NameValuePair("productid","48661"),
        		                new NameValuePair("xh",""),
        		                new NameValuePair("seed","")};
